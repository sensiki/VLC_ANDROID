...
public class VlcVideoActivity extends Activity implements SurfaceHolder.Callback, IVideoPlayer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMediaPlayer.playMRL("rtsp://192.168.100.192/aaa.sdp");
//        mMediaPlayer.playMRL("rtsp://192.168.0.109:1554/cam/realmonitor?channel=1&subtype=0&unicast=true");
//		mMediaPlayer.playMRL("rtsp://admin:admin@192.168.0.101:7070/onvif-stream1");
//		mMediaPlayer.playMRL("rtsp://admin:admin@192.168.0.106/stream1");
//		rtsp://192.168.0.106/stream1
//		mMediaPlayer.playMRL("rtsp://admin:admin@192.168.0.46:554");
//		CameraClient.setClientIndex(-1,"rtsp://192.168.0.101:7070/onvif-stream1");
//		rtsp://192.168.0.106/stream1
